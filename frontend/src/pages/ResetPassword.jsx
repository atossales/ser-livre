...
const G = {
  50:"#FBF7EE", 100:"#F5ECDA", 200:"#EBDAB5", 500:"#A8872E", 600:"#8B6D1E", 700:"#6E5517"
};
    ...
    <div style={{ minHeight:'100vh', background:G[50], display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'system-ui, sans-serif' }}>
      <div style={{ background:'white', borderRadius:12, padding:40, width:'100%', maxWidth:420, boxShadow:'0 4px 24px rgba(0,0,0,0.08)' }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h1 style={{ color:G[700], fontSize:22, fontWeight:700, margin:0 }}>Redefinir senha</h1>
          <p style={{ color:'#666', marginTop:8, fontSize:14 }}>Digite sua nova senha abaixo.</p>
        </div>

        {done ? (
          <div style={{ textAlign:'center' }}>
            <div style={{ fontSize:48, marginBottom:16 }}>✅</div>
            <h2 style={{ color:G[600] }}>Senha redefinida!</h2>
            <p style={{ color:'#666' }}>Você já pode fazer login com a nova senha.</p>
            <button
              onClick={() => navigate('/')}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom:24 }}>
              <label style={{ display:'block', fontSize:13, fontWeight:600, color:G[700], marginBottom:6 }}>Confirmar nova senha</label>
              <input
                type="password"
                value={confirm}
